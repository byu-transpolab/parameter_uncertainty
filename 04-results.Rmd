...
```{r modechoicetrips, warning = FALSE, echo = FALSE, message = FALSE, results='asis', fig.cap = "Trip desnity for coefficient of variation by mode for HBW trips.", fig.env= "sidewaysfigure", fig.align="center", fig.width=9}
set.seed(1)
