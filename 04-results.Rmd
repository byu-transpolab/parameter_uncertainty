...
```{r modechoicetrips, warning = FALSE, echo = FALSE, message = FALSE, results='asis', fig.cap = "Trip density for coefficient of variation by mode for HBW trips.", fig.env= "sidewaysfigure", fig.align="center", fig.width=9}
set.seed(1)
...
```{r networksd, warning = FALSE, echo = FALSE, message = FALSE, fig.align="center", results='hide', fig.keep='all', fig.cap = "Standard deviation in daily forecasted volume.", fig.env= "sidewaysfigure"}
tar_load(networks)
...
```{r totalvolume, echo = FALSE, warning = FALSE, fig.cap = "Coefficient of variation in daily link volume by facility type.", out.width = "80%", fig.align="center"}
tar_load(networks)
...
```{r densityplots, warning = FALSE, echo = FALSE, message = FALSE, fig.align="center", results='asis', fig.cap = "Density plot of forecasted volume on selected links, with default parameter results marked in red, and AAWDT values in green.", fig.env= "sidewaysfigure", fig.width=9}
set.seed(109)
...
fac_density <- density %>%
 ...
 ggplot() +
  ...
  labs(x = "Total Link Volume (in 1000s of Vehicles)",
       y = "Density")
```
