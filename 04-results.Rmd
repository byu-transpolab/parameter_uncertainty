...
```{r totalvolume, echo = FALSE, warning = FALSE, fig.cap = "Coefficient of variation in daily link volume by facility type for a random sample of highway links.", out.width = "80%", fig.align="center"}
set.seed(1)
