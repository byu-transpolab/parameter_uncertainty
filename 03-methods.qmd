...
This logsum value is then used as the primary impedance for a destination choice model [@ben1985discrete]. Destination choice estimates travel patterns based on mode choice, trip generators (workers and households), and destination choice parameters. These parameter values are also shown in Table \@ref(tab:choicecoeff).The destination choice utility is the primary impedance (mode choice logsum value) plus the natural log of the size term, where the sized term is calculated as:
\begin{equation}
...
```{r parameter100, echo = FALSE, fig.align="center", results='asis', out.width = "80%"}
#| label: fig-parameter100
#| fig.cap: Sampled mode and destination choice parameters for HBW trip purpose, 100 draws.
...
```{r parameter600, echo = FALSE, fig.align="center", results='asis',  out.width = "80%"}
#| label: fig-parameter600
#| fig.cap: Sampled mode and destination choice parameters for HBW trip purpose, 600 draws.
...
```{r hbostats, warning = FALSE, echo = FALSE, message = FALSE, fig.align="center", results='asis',  out.width = "80%"}
#| label: fig-hbostats
#| fig.cap: HBO average mode choice logsum cumulative mean with 100 and 600 draws and 95 percent CI bands.
...
```{r nhbstats, warning = FALSE, echo = FALSE, message = FALSE, fig.align="center", results='asis', out.width = "80%"}
#| label: fig-nhbstats
#| fig.cap: NHB average mode choice logsum cumulative mean with 100 and 600 draws and 95 percent CI bands.
