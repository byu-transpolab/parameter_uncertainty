...
```{r choicecoeff, echo = FALSE, fig.cap = "Choice Model Parameters"}
tar_load(mc_coeff)
tar_load(mc_const)
tar_load(dc_coeff)
...
```{r hbwcm, warning = FALSE, echo = FALSE, message = FALSE, fig.align="center", results='asis', fig.cap = "HBW average mode choice logsum cumulative mean with 100 and 600 draws and 95 percent CI bands.",  out.width = "80%"}
...
```{r hbostats, warning = FALSE, echo = FALSE, message = FALSE, fig.align="center", results='asis', fig.cap = "HBO average mode choice logsum cumulative mean with 100 and 600 draws and 95 percent CI bands.",  out.width = "80%"}
...
```{r nhbstats, warning = FALSE, echo = FALSE, message = FALSE, fig.align="center", results='asis', fig.cap = "NHB average mode choice logsum cumulative mean with 100 and 600 draws and 95 percent CI bands.", out.width = "80%"}
